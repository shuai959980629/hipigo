...
J.Popup = (function($){
    var _popup,_mask,transition,clickMask2close,
        ...
        TEMPLATE = {
            ...
            confirm : '<div class="popup-title">{title}</div><div class="popup-content">{content}</div><div id="popup_btn_container"><a class="close">{cancel}</a><a class="checkmark">{ok}</a></div>',
    ...
    var confirm = function(title,content,okCall,cancelCall){
        ...
        show({
            ...
            clickMask2Close : false,
            showCloseBtn : false
        });//#popup_btn_container [data-icon="checkmark"]
        $('#popup_btn_container [class="checkmark"]').tap(function(){
            hide();
            okCall.call(this);
        });//#popup_btn_container [data-icon="close"]
        $('#popup_btn_container [class="close"]').tap(function(){
            hide();
...
;(function($){
    function slider(selector,showDots){
        ...
        var _init = function() {
            ...
            slideWidth = wrapper.offset().width + 20; //BY JAMAI  增加 20 有滚动条
        ...
        var _initDots = function(){
            ...
            if(dots.length>0){
                ...
                wrapper.append(html);
                dots = wrapper.find('.dots');
                //BY Jamai  update width: auto
                dots.children().css('width','auto');
